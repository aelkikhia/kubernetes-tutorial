...
build docker images
docker build --platform linux/arm64 -t aelkikhia/multi-client:latest -f ./client/Dockerfile ./client 
docker build --platform linux/arm64 -t aelkikhia/multi-server:latest -f ./server/Dockerfile ./server 
docker build --platform linux/arm64 -t aelkikhia/multi-worker:latest -f ./worker/Dockerfile ./worker 
